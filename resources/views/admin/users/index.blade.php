...
<nav class="py-3 px-5">
    <ol class="flex flex-wrap text-sm">
        ...
        <li class="text-indigo-600 font-medium" aria-current="page">Users</li>
    </ol>
</nav>
@endsection
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if(isset($user->role) && $user->role)
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-indigo-100 text-indigo-800">{{ $user->role}}</span>
                                    @else
