...
<div class="container mx-auto px-4 py-6">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800">Add New Skiza Tune</h1>
    </div>

    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.skiza-tunes.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-500">Upload an MP3 file (Max: 10MB)</p>
                @error('mp3_file')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="border border-gray-300 rounded-md p-4">
                    <p class="mb-2 text-sm text-gray-600">Add download instructions (optional)</p>
